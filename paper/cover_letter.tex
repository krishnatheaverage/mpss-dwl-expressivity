...
magnitude homology separates digraphs on which both reciprocity-aware
refinement and the directed distance multiset agree; and a
component-counting description of degree-two magnitude homology,
building on a basis of Ivanov and Mukoseev, identifies the mechanism
behind these separations with closed formulas.
...
1,550,786 digraphs, and every reported witness was re-verified from
scratch. All code and data are public (GitHub, and Zenodo
DOI~10.5281/zenodo.21138733), including scripts that reproduce every
number and table in the paper.
