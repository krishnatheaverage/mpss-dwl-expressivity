...
and \ref{thm:beyonddist} all occur in magnitude homology of degree two.
...
$9{,}842$ digraphs with $3 \le n \le 5$, in every grading, with zero
mismatches.
...
implementation on all $9{,}842$ digraphs in every grading. The
...
architectures partially recover by edge-typing reciprocal arcs;
Question~\ref{q:dwlplusdist} asks whether magnitude homology sees beyond
even that.
